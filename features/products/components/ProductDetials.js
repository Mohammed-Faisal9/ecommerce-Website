...
export default function ProductDetials({ detials, imageId }) {
  return (
    <section className="py-12">
      <Wrapper className="grid md:grid-cols-[1fr_350px] gap-12 items-center">
        <div className="">
          ...
          <p className="text-neutral-500">{detials}</p>
        </div>
        <div className=" bg-blue-300 max-h-[340px] relative flex items-center justify-center rounded-lg cursor-pointer">
          ...
          <Image width="300" height="300" src={getImageUrl(imageId)} alt="product" />
        </div>
      </Wrapper>
    </section>
  );
